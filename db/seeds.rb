...
Page.create(
  ...
  It was obtained from Kaggle and was made by Mario Tormo Romero, I modified it to include the names of the regions for each generation. This data also includes region photos from the Pokémon Wiki.',
)
