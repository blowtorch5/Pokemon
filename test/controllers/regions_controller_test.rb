...
class RegionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create region" do
    assert_difference("Region.count") do
      post regions_url, params: { region: { generation_id: @region.generation_id, name: @region.name } }
    end
  ...
  test "should update region" do
    patch region_url(@region), params: { region: { generation_id: @region.generation_id, name: @region.name } }
